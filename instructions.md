...
In this lab, you apply GDPR analysis to your own Week 5 Project project. Not a fictional scenario — the system you actually built.
...
- **Learning objectives:** By the end, you can produce a first-pass GDPR compliance assessment of a system you built, map the personal data flows and roles involved, identify the gaps between your design choices and the regulation's requirements, and produce a short client-facing recommendation memo.
- **Lesson setup requirements:** Complete `01_gdpr-fundamentals.md` before starting. Review the sections on controllers vs processors, lawful bases, purpose limitation, DPIA triggers, international transfers, and law stacking with the AI Act and ePrivacy.

---

## Submission hygiene

- **Filenames:** Use clear, descriptive names (avoid vague names such as `audit.md` or `gdpr_final_v2.pdf`).
...
- Apply the **accountability principle** directly: list every piece of documentation a regulator could ask for in an audit (DPA, LIA, DPIA, privacy notice, retention schedule, records of processing activities). Tick what exists. What is entirely missing from your project?
- Revisit one data flow where you marked `TBD — legal review`. What would a lawyer actually need to know to advise on it? What information could you prepare in advance to make that conversation efficient?

## Stretch

Take the highest-risk processing activity in your system and build a mini **data protection by design checklist** for it:

| Design principle | Current state of your system | Pass / Fail / Unknown |
|---|---|---|
| Data minimisation: only the minimum necessary data is collected | | |
| Purpose binding: data is technically restricted to the stated purpose | | |
| Access controls: access is limited to those who need it | | |
| Retention enforcement: automated deletion or anonymisation is in place | | |
| Subject rights workflow: system can support an access or erasure request within 30 days | | |
| Incident response: breach detection and 72-hour notification process is documented | | |

For any Fail or Unknown, describe what would need to change. Keep this to half a page.
